...
import nl.fw.yapool.sql.hibernate.Hib43ConnectionProvider;
	...
	public void testHibernateDbInMem() {
		...
		*/
		...
		try {
			...
			pool = Hib43ConnectionProvider.getProvidedPools().get(HibernateTestCP.poolId);
			...
			Hib43ConnectionProvider.getProvidedPools().removePool(HibernateTestCP.poolId);
			if (error != null) 
